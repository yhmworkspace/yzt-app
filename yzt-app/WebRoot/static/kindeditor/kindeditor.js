...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var html = '<img src="' + _escape(url.replace("system/","")) + '" data-ke-src="' + _escape(url.replace("system/","")) + '" ';
		if (width) {
...
_extend(KEdit, KWidget, {
	...
	init : function(options) {
		...
		self.iframe = K('<iframe class="ke-edit-iframe" name="iframeName" hidefocus="true" frameborder="0"' + iframeSrc + '></iframe>').css('width', '100%');
