...
public class YztChoicenesscontentObj {
    @Id
    private String id;
	 ...
	 * 0是未收藏 1是已收藏
     */
	private Integer choicenesscontentFlag;
	...
	public Integer getChoicenesscontentFlag() {
		return choicenesscontentFlag;
	}

	public void setChoicenesscontentFlag(Integer choicenesscontentFlag) {
		this.choicenesscontentFlag = choicenesscontentFlag;
	}
