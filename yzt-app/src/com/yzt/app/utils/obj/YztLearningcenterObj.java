...
public class YztLearningcenterObj {
    private String id;
    ...
    //评论list
    public List<YztLearningcenterCommentObj> commentlist;
    //介绍html链接
	...
	public List<YztLearningcenterCommentObj> getCommentlist() {
		return commentlist;
	}

	public void setCommentlist(List<YztLearningcenterCommentObj> commentlist) {
	...
	public void setTvPicurl(String tvPicurl) {
		this.tvPicurl = tvPicurl;
	}
