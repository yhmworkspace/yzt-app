 ...
 */
@Controller
@RequestMapping("/system/choicenesscontent/comment")
public class ChoicenesscontentCommentController extends BaseController {
	...
	public String index(@PathVariable String choicenesscontentId, ModelMap m){
		...
		return "system/jxnr/comment/commentlist";
	}
	...
	public EasyuiDataGridJson listjson(@PathVariable String choicenesscontentId,EasyuiDataGrid dg, ModelMap m){
		...
		return choicenesscontentCommentService.datagrid( dg,choicenesscontentId);
	}
