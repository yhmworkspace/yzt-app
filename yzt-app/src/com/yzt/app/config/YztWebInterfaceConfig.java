 ...
 * 日期：2013-11-13
 * 作者：chu
 * YztWebInterfaceConfig
 **/
public class YztWebInterfaceConfig {
	public static String userid = "87ACA21FD20C9C52";
	public static String key = "RBYH5E1nfO8OQ7e5Yh1IVvIGIMkHSXPK";
	...
	//生成视频接口
	public static String api_createVideo = "http://spark.bokecc.com/api/videos";
