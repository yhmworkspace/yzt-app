...
@Service("learningcenterCommentService")
public class LearningcenterCommentServiceImpl extends BaseServiceImpl<YztLearningcenterComment> implements LearningcenterCommentService{
	@Autowired
