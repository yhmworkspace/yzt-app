...
public class IndexPicServiceImpl extends BaseServiceImpl<YztIndexPic> implements IndexPicService {
	@Override
	public EasyuiDataGridJson datagrid(YztIndexPic fb, EasyuiDataGrid dg) {
		EasyuiDataGridJson listjson = new EasyuiDataGridJson();
		Example example = new Example(YztIndexPic.class);
