...
@Service("indexLogoService")
public class IndexLogoServiceImpl extends BaseServiceImpl<YztIndexLogo> implements IndexLogoService {
	@Override
	public EasyuiDataGridJson datagrid(YztIndexLogo fb, EasyuiDataGrid dg) {
		EasyuiDataGridJson listjson = new EasyuiDataGridJson();
		Example example = new Example(YztIndexLogo.class);
